...
/**
 * Retourne la liste des noms des visiteurs
 * @return un tableau avec les noms des visiteurs
 */
 public static function getNomVisiteurs(){
...
*/
    public static function getIdVisiteur($nomVisiteur,$PrenomVisiteur ){
    	$req = "select salaries.id from  salaries where salaries.nom = '$nomVisiteur'";
    	$res = PdoGsb::$monPdo->query($req);
